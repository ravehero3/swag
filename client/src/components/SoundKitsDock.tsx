...
const SoundKitsDock: React.FC<SoundKitsDockProps> = ({ items }) => {
  ...
  return (
    <div ref={containerRef} style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '64px', paddingTop: '0px', background: 'transparent', overflow: 'visible', position: 'relative' }}>
      ...
      <div className="dock-container-mobile" style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', overflowX: 'visible', overflowY: 'visible', padding: '20px 0', marginTop: '400px', position: 'relative', zIndex: 99999 }}>
