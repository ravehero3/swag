...
const ArtistCarousel = () => {
  ...
  return (
    ...
    >
      ...
      `}</style>
      <div className="carousel-root-container" style={{ textAlign: "center", marginBottom: "24px", paddingTop: "0px", position: "relative", zIndex: 99999, overflow: "visible", background: "transparent" }}>
