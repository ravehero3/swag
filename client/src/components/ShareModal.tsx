        ...
        <div style={{ padding: "24px" }}>
          {activeTab === "link" && (
            <>
              ...
              <button
                onClick={() => window.open(`https://wa.me/?text=${encodeURIComponent(`${resolvedTitle} – ${shareUrl}`)}`, "_blank")}
                style={{ width: "100%", padding: "13px", background: "#25D366", color: "#fff", border: "none", borderRadius: "4px", fontSize: "14px", fontWeight: "600", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: "10px", marginBottom: "10px" }}
              >
