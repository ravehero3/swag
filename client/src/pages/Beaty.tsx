    ...
    <div className="fade-in-section delay-1">
      ...
      <div style={{ padding: "0 20px" }} className="fade-in-grid">
        ...
        <div ref={beatsListRef} className="scroll-fade-section" style={{ marginBottom: "48px", maxWidth: "1200px", margin: "0 auto", marginTop: "60px" }}>
          ...
          {otherBeats.length === 0 && !highlightedBeat ? (
            ...
            <>
              <div style={{ display: "flex", alignItems: "center", padding: "16px 16px 8px 58px", gap: "16px", marginTop: "16px", position: "relative" }}>
                ...
                <div style={{ position: "absolute", bottom: 0, left: "122px", right: "24px", height: "1px", background: "#333" }} />
            ...
            >
              <div data-separator style={{ position: "absolute", bottom: 0, left: "122px", right: "24px", height: "1px", background: "#333", opacity: 1, transition: "opacity 0.15s ease" }} />
          ...
          <div className="fade-in-section delay-3" style={{ display: "flex", justifyContent: "center", gap: "16px", marginTop: "16px", marginBottom: "32px", marginLeft: "626px", position: "relative", zIndex: 9999, alignItems: "center", pointerEvents: "auto" }}>
              <button
        ...
        {isHomePage && (
          <>
            <div ref={artistCarouselRef} className="fade-in-section delay-3 scroll-fade-section" style={{ marginTop: "-100px", marginBottom: "-420px", position: "relative", zIndex: 50 }}>
