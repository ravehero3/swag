...
function WaveformModal({ beat, onClose }: { beat: Beat; onClose: () => void }) {
  ...
  return (
    <div
      style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.75)", zIndex: DESIGN_SYSTEM.zIndex.modal, display: "flex", alignItems: "center", justifyContent: "center" }}
      onClick={onClose}
    >
      <div
...
function JourneysTab() {
  ...
  const saveStep = async () => {
    ...
    if (!editingStep && insertStepIdx !== null) {
      body.insertAtIdx = insertStepIdx;
    }
    if (editingStep) {
    ...
    <div>
      ...
      {loading ? (
        ...
        <>
          ...
          {/* Journey Sequence */}
          {detail?.journey && (
            <div style={{ marginTop: "40px", maxHeight: "1200px", overflowY: "auto", paddingRight: "12px" }}>
