      ...
      <div style={{ background: "#000", minHeight: "100vh" }}>
        <div style={{ width: "100vw", marginLeft: "calc(-50vw + 50%)", marginTop: "-42px", marginBottom: "24px", overflow: "hidden", position: "relative", background: "#000", height: "clamp(320px, 52vh, 480px)" }}>
          ...
          <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center", pointerEvents: "none", zIndex: 2 }}>
            <img src="/uploads/artwork/voodoo808-main-logo.png" alt="VOODOO808" className="hero-logo-img" style={{ width: "min(1200px, calc(100vw - 40px))", height: "auto", objectFit: "contain", display: "block" }} />
          </div>
      ...
      <div className="mobile-video-container desktop-main-video" style={{ width: "100vw", marginLeft: "calc(-50vw + 50%)", marginTop: "-42px", marginBottom: "24px", overflow: "hidden", position: "relative", background: "#000", height: "clamp(380px, 56vh, 540px)" }}>
        ...
        <div style={{ position: "absolute", top: 0, bottom: "80px", left: 0, right: 0, paddingTop: "44px", display: "flex", alignItems: "center", justifyContent: "center", pointerEvents: "none", zIndex: 2 }}>
          <img
            ...
            style={{ width: "min(1200px, calc(100vw - 40px))", height: "auto", objectFit: "contain", display: "block" }}
          />
        </div>
        <div
          style={{
          ...
          {otherBeats.length === 0 && !highlightedBeat ? (
            ...
            <div
              ...
              onMouseEnter={(e) => {
                ...
                target.style.border = "1px solid rgba(255,255,255,0.10)";
