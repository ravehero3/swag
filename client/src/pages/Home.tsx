          ...
          {otherBeats.length === 0 && !highlightedBeat ? (
            ...
            <>
              <div style={{ display: "flex", alignItems: "center", padding: "16px 16px 8px 16px", gap: "16px", marginTop: "16px", position: "relative" }}>
                ...
                <div className="mobile-hide" style={{ width: "240px", marginRight: "12px", marginLeft: "64px", fontWeight: "400", fontFamily: "Helvetica Neue, Helvetica, Arial, sans-serif", fontSize: "12px", color: "#666" }}>NÁZEV</div>
                <div style={{ position: "absolute", bottom: 0, left: "144px", right: "16px", height: "1px", background: "#333" }} />
                <div className="desktop-only" style={{ width: "80px", marginLeft: "10px" }}><button onClick={() => { setSortBy(sortBy === "bpm" ? "bpm" : "bpm"); setSortAsc(sortBy === "bpm" ? !sortAsc : false); }} style={{ background: "none", border: "none", fontWeight: "400", fontFamily: "Helvetica Neue, Helvetica, Arial, sans-serif", fontSize: "12px", color: "#666", cursor: "pointer", padding: 0 }}>BPM {sortBy === "bpm" && (sortAsc ? "↑" : "↓")}</button></div>
