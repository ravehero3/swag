          ...
          {otherBeats.length === 0 && !highlightedBeat ? (
            ...
            <>
              <div style={{ display: "flex", alignItems: "center", padding: "16px 16px 8px 16px", gap: "16px", marginTop: "16px", position: "relative" }}>
                ...
                <div style={{ width: "240px", marginRight: "12px", marginLeft: "144px", fontWeight: "400", fontFamily: "Helvetica Neue, Helvetica, Arial, sans-serif", fontSize: "12px", color: "#666" }}>NÁZEV</div>
