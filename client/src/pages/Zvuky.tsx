                    ...
                    >
                      {!kit.is_free && (
                        <div style={{ position: "relative", display: "flex", alignItems: "center", justifyContent: "center" }}>
                          ...
                          <span style={{ position: "absolute", top: "-6px", right: "22px", fontSize: "10px", fontWeight: "bold", color: "#fff", background: "#24e053", borderRadius: "50%", width: "16px", height: "16px", display: "flex", alignItems: "center", justifyContent: "center" }}>+</span>
                        </div>
                      )}
